...
public class LanguageController {
    ...
    public ResponseEntity create(@RequestBody LanguageDTO language){
        return new ResponseEntity<>(service.create(language), HttpStatus.OK);
    }

    @PutMapping(value = "/{id}/update")
    public ResponseEntity update(@PathVariable(value = "id") String id, @RequestBody LanguageDTO language){
        return new ResponseEntity<>(service.update(id, language), HttpStatus.OK);
    }
